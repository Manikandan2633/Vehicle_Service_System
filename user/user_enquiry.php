        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="user_enquiry">Enquiry Form</a>
   ...
   if(isset($_POST['submit'])){
      ...
      //$images =$_FILES ['image']['name'];
        ...
        //header('location:login_form.php');
           ...
           $insert = "INSERT INTO enquiry_form(username,enquiry , description) VALUES('$username','$enquiry','$description')";
...
<div class="container">
    <div class="modal-content">
        <div class="modal-header">
           <h5 class="modal-title font-weight-bold">ENQUIRY FORM</h5>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="form-group row">
                <label class="col-sm-2 col-form-label font-weight-bold">Enquiry</label>
                <div class="col-sm-10">
                   <select class="form-select col-sm-12 p-2" name="enquiry" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea rows="5" cols="94" name="description"></textarea>
                </div>
            </div>

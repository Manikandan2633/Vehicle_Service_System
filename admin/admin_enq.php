...
<div class="card-body">
    <div class="table-responsive ml-2 bg-white">
        ...
        <table class="table table-bordered" id="datatable" width="100%" >
            ...
            <thead>
                <tr>
                <th class=" h5 text-primary font-weight-bold">S.NO</th>
                    <th class=" h5 text-primary font-weight-bold">DATE</th>
                    <th class=" h5 text-primary font-weight-bold">TYPE</th>
                    <th class=" h5 text-primary font-weight-bold">DESCRIPTION</th>
                    <th class=" h5 text-primary font-weight-bold">RESPOND</th>
                </tr>
            </thead>
            <tbody>
            <tr>
               <?php
                   ...
                   <td> <?php echo $row['id'] ?> </td>
                    ...
                    <td>
                    <form id="myForm" action="respond.php" method="post">
                        <input type="hidden" name="respond_id" value="<?php echo $row['id'];?>">
                    <?php
                    if($row['response']== null)
                    {
                        echo '<button class="btn btn-success" id="change" name="respond_btn">RESPOND</button>';
                    }
                    else{
                        echo '<button class="btn btn-danger" id="change" name="respond_btn disabled">RESPONDED</button>';
                    }
                    ?>
                   </form>
